 ...
 * @author paulojp
 */
public class JFEmprestimoAluno extends javax.swing.JFrame {  
    ...
    JFEmprestimoAluno(JFPrincipal telaPrincipal) {
    ...
    private void initComponents() {
        ...
        jT1Matricula = new javax.swing.JTextField();
        ...
        jT1Matricula.setBackground(new java.awt.Color(204, 255, 204));
        jT1Matricula.setFont(new java.awt.Font("Microsoft YaHei", 0, 18)); // NOI18N
        ...
        jBExcluir1.setBorderPainted(false);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jT1Matricula, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jT1Matricula, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jT0IdEmprestimo, jT1Matricula, jT2IdLivro, jT3DataEmprestimo, jT4DataDevolucao});
    ...
    private void jTableEmprestimoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableEmprestimoMouseClicked
        ...
        jT1Matricula.setText(jTableEmprestimo.getValueAt(linhaSelecionada, 1).toString());
        ...
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, "Erro ao listar livro.");
        }
    ...
    private void jTableAlunoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableAlunoMouseClicked
        ...
        jT1Matricula.setText(jTableAluno.getValueAt(linhaSelecionada, 0).toString()); 
    ...
    private void jBDevolverMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBDevolverMouseClicked
        try {
            ...
            Logger.getLogger(JFEmprestimoAluno.class.getName()).log(Level.SEVERE, null, ex);
        } 
                ...
                if (verificaDisponibilidadeLivro()) {
                    ...
                    if (verificaEmprestimo()){
                        try {
                            ...
                            e.setMatricula(Integer.valueOf(jT1Matricula.getText()));
                        ...
                        JOptionPane.showMessageDialog(rootPane, "O aluno com a mátricula "+jT1Matricula.getText()+" já possui um empréstimo pedente");
                    }
                }
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, "Para cadastrar selecione apenas os campos 'Aluno' e 'Livro' nas tabelas.\n\n"
    ...
    private boolean verificaDados() {
        ...
        if ((!jT1Matricula.getText().equals("")) && (!jT2IdLivro.getText().equals("")) 
    ...
    public Boolean verificaEmprestimoAluno() throws SQLException {
        // Salva a posição da linha selecionada na tabela de pesquisa
        int linhaSelecionada = jTableAluno.getSelectedRow();
        
        BdEmprestimoAluno b = new BdEmprestimoAluno();
        
        emprestimos = b.verificaEmprestimoAluno(Integer.valueOf(jT1Matricula.getText()));
    ...
    // Método p/ verifica se o livro está disponível
    private boolean verificaEmprestimo() throws SQLException {
        if (verificaEmprestimoAluno()==true) {
            return true;
        }else{
            return false;
        }
    ...
    private void listaContatosLivroEmprestimo() throws SQLException { 
        BdLivro d = new BdLivro();
        livros = d.select(Integer.valueOf(pegaIdLivro())); 
    ...
    private void devolveLivro() throws SQLException, ParseException {
        ...
        if (jTableEmprestimo.getSelectedRow() != -1) {
            ...
            if (diferencaData() > 0) {
                JOptionPane.showMessageDialog(rootPane, "Livro devolvido após o prazo de vencimento.\n"
    ...
    private void desabilitaCamposEmprestimo() {
        ...
        jT1Matricula.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFEmprestimoAluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFEmprestimoAluno().setVisible(true);
            }
        });
    }    
    ...
    private javax.swing.JTextField jT1Matricula;
